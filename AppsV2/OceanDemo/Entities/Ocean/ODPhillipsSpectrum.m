...
- (double) getAmplitudeAt:(const Vector2 * const)k
{
    ...
    double windDirectionSquareLength 
        = v2_v_square_length(&(currentSettings.windDirection));

    double L = windDirectionSquareLength / EARTH_ACCELERATION;

    Vector2 windDirectionNormalised = v2_v_normalised(&(currentSettings.windDirection));
