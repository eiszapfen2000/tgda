...
\begin{align}
\label{eq:plane_and_ray}
 \mvec{p}\transpose{\mvec{n}} - d & = 0 & \mvec{p} & = \mvec{a} + t\mvec{b}
\end{align}

\begin{align}
\label{eq:plane_and_ray_intersection}
(\mvec{a} + t\mvec{b})\transpose{\mvec{n}} - d & = 0\notag\\
\mvec{a}\transpose{\mvec{n}} + t\mvec{b}\transpose{\mvec{n}} - d & = 0\notag\\
\Longrightarrow t & = \cfrac{d - \mvec{a}\transpose{\mvec{n}}}{\mvec{b}\transpose{\mvec{n}}}
\end{align}
