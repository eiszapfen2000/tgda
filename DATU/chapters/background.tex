...
\end{gather}
%
where $t$ in combination with equation~\ref{eq:proj_grid_ray} gives the intersection of
the ray with the plane. If $(\mvec{e} - \mvec{d})\transpose{\mvec{n}} = 0$, then there
is no intersection.
