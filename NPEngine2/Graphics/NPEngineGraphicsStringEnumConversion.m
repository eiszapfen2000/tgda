...
+ (void) initialize
{
    ...
    INSERTENUM(uniformTypes, NpUniformBool,  @"bool");
    INSERTENUM(uniformTypes, NpUniformBool2, @"bvec2");
    INSERTENUM(uniformTypes, NpUniformBool3, @"bvec3");
    INSERTENUM(uniformTypes, NpUniformBool4, @"bvec4");
