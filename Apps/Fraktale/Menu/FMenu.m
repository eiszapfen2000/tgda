...
+ (void) alignRectangle:(FRectangle *)rectangle withAlignment:(NpState)alignment
{
    switch ( alignment )
    {
        ...
        case F_MENUITEM_ALIGNMENT_TOPRIGHT:
        {
        ...
        case F_MENUITEM_ALIGNMENT_RIGHT:
        {
        ...
        case F_MENUITEM_ALIGNMENT_BOTTOMRIGHT:
        {
        ...
        case F_MENUITEM_ALIGNMENT_BOTTOM:
        {
        ...
        case F_MENUITEM_ALIGNMENT_BOTTOMLEFT:
        {
        ...
        case F_MENUITEM_ALIGNMENT_LEFT:
        {
