...
@interface NPEffectVariableInt : NPEffectVariableUniform
{
    int32_t value;
}
...
@interface NPEffectVariableInt2 : NPEffectVariableUniform
{
    IVector2 value;
}
...
@interface NPEffectVariableInt3 : NPEffectVariableUniform
{
    IVector3 value;
}
...
@interface NPEffectVariableInt4 : NPEffectVariableUniform
{
    IVector4 value;
}
