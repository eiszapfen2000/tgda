...
into a framework which gives coherent, correct and consistent results.
\item Based on the work by \citet{course:simulatingocean}, implement a real-time
ocean surface synthesis algorithm.
\item Adopt the work by \citet{article:oceanlighting} for real-time ocean surface
rendering.
