	...
	\begin{minipage}{\textwidth}
		\begin{block}{Results}
			\begin{columns}[t]
				...
				\begin{center}
				\noindent
				\includegraphics[width=0.3\textwidth]{figures/20-06-2018_14-49-57_complete}\hspace{0.05\textwidth}%
				\includegraphics[width=0.3\textwidth]{figures/20-06-2018_14-49-57_complete}\\[2em]
				\includegraphics[width=0.3\textwidth]{figures/20-06-2018_14-49-57_complete}\hspace{0.05\textwidth}%
				\includegraphics[width=0.3\textwidth]{figures/20-06-2018_14-49-57_complete}	
				\end{center}
				\end{column}
			\end{columns}
		\end{block}
