...
%				Brak\cite{ff2010}
				\noindent
				\includegraphics[width=0.3\columnwidth]{figures/21-06-2018_10-44-51_complete}
				\includegraphics[width=0.3\columnwidth]{figures/21-06-2018_13-45-06_complete}
				\includegraphics[width=0.3\columnwidth]{figures/21-06-2018_12-48-51_complete}	
				\end{center}
				\end{column}
			\end{columns}
		\end{block}
