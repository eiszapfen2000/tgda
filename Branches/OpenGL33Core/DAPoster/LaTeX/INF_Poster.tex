...
%				Brak\cite{ff2010}
				...
				\noindent
				\includegraphics[width=0.45\columnwidth]{figures/20-06-2018_14-49-57_complete}\hspace{0.025\columnwidth}%
				\includegraphics[width=0.45\columnwidth]{figures/21-06-2018_15-47-53_complete}\\[0.025\columnwidth]
				\includegraphics[width=0.45\columnwidth]{figures/21-06-2018_10-44-51_complete}\hspace{0.025\columnwidth}%
				\includegraphics[width=0.45\columnwidth]{figures/21-06-2018_12-48-51_complete}	
				\end{center}
				\end{column}
			\end{columns}
		\end{block}
