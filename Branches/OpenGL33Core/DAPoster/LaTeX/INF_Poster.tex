...
%					\centering
%					\noindent
					\subfloat[\label{fig:a}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_grid}}
					\subfloat[\label{fig:b}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_ross}}
					\subfloat[\label{fig:c}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_sky}}\\[0.0125\columnwidth]
					\subfloat[\label{fig:d}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_sea}}
					\subfloat[\label{fig:e}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_whitecaps}}
					\subfloat[\label{fig:f}]{\includegraphics[width=0.3\columnwidth]{figures/28-05-2018_10-56-10_complete}}
					\end{figure}
				\end{column}
