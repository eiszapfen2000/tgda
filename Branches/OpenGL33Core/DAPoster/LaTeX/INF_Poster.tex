...
%				Brak\cite{ff2010}
%				\noindent
				\subfloat{\includegraphics[width=0.3135\columnwidth]{figures/21-06-2018_10-44-51_complete}}
				\hfill
				\subfloat{\includegraphics[width=0.3135\columnwidth]{figures/21-06-2018_13-45-06_complete}}
				\hfill
				\subfloat{\includegraphics[width=0.3135\columnwidth]{figures/21-06-2018_12-48-51_complete}}
				\end{figure}
%				\end{center}
				\end{column}
			\end{columns}
