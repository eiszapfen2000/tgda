	...
	\begin{minipage}{\textwidth}
		\begin{block}{Results}
			\begin{columns}[t]
				...
				\noindent
				\includegraphics[width=0.45\columnwidth]{figures/20-06-2018_14-49-57_complete}\hspace{0.05\columnwidth}%
				\includegraphics[width=0.45\columnwidth]{figures/20-06-2018_14-49-57_complete}\\[2em]
				\includegraphics[width=0.45\columnwidth]{figures/20-06-2018_14-49-57_complete}\hspace{0.05\columnwidth}%
				\includegraphics[width=0.45\columnwidth]{figures/20-06-2018_14-49-57_complete}	
				\end{center}
				\end{column}
			\end{columns}
		\end{block}
