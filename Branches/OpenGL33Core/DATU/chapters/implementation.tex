...
and \citet{article:whitecaps} with a novel multi-resolution scheme,
where specific
...
\end{tikzpicture}
\caption[The displaced wave profile and self-intersections.]{
...
\citet{article:whitecaps} with a novel multi-resolution scheme, where
specific pattern
...
\end{groupplot}
\end{tikzpicture}
\caption[A one-dimensional \wavenumber spectrum with subsequent, reduced pattern sizes.]{
...
\label{sec:implementation:multires}
%
%
\begin{figure}[p]
\centering
