...
meshing scheme which seeks to provide more detail close to the viewer. But
their approach starts with a coarse mesh in world space, which is then
dynamically refined dependent on the current camera position and the camera's 
respective view frustum. The actual refinement is computed inside a geometry shader, adding or removing triangles as needed.}
