...
based approach \citep{course:simulatingocean}, as it allows us to, one,
leverage the \FastFourierTransform algorithm, and two, seamlessly tile
the ocean surface. An additional up-side is that oceanographic research
provides a wide range of wave energy spectra which are specifically
