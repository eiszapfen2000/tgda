...
aspects:
is the model able to generate believable ocean geometry, for what
kind of sea is the model most adequate for, and, is the model suitable
for the lighting scheme used in \citet{misc:oceanlightingfft}.
...
as it gives our camera full freedom of movement.
...
Now that we have taken care of the summary and our contributions,
