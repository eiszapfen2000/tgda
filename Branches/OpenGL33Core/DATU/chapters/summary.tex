...
%our contributions.
We gave an in-depth discussion of five distinct wave spectrum models.
For each model we determined, first, its ability to generate believable
ocean geometry, second, the kind of sea it is most adequate for, and
third, its suitability for the lighting scheme used in \citet{misc:oceanlightingfft}.
...
Moreover, instead of using the projected grid variant by
...
Last, we improved upon \citet{misc:oceanlightingfft}'s implementation
...
Now that we have given a compact summary of our work and our contributions,
