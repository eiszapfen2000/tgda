...
We have shown the integration of the wave spectrum concept from
oceanographic research into a coherent framework for the display
of believable ocean surfaces via computer graphics algorithms.
