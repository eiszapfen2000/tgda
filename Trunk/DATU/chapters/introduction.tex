...
\begin{figure}[p]
\centering
\includegraphics[scale=0.85]{figures/oceannoaaoceantoday.png}
...
\begin{figure}[p]
\centering
\includegraphics[scale=0.85]{figures/storm300.jpg}
...
\begin{figure}
\centering
\includegraphics[scale=0.625]{figures/ocean300.jpg}
\caption{The late afternoon sun illuminating the ocean surface. Source:~\cite{misc:noaa:sunset}}
