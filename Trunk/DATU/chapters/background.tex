...
to the vertical displacement $\eta$. To simplify the mathematics we assume a two-dimensional ocean,
with one dimension representing the wave's direction of travel and the other the wave's vertical
displacement. With these assumptions it follows that:
%
\begin{equation}
...
$\lambda$ is the~\emph{wave length},~$f$ is the~\emph{wave frequency} in Hertz (Hz) and~$T$ is the wave period.
%
\fxfatal{Add image}

\subsection{The Dispersion Relation}
\label{sec_dispersion_relation}
...
\end{equation}
%
where $g$ is the acceleration of earth's gravity and $d$ is the water depth.
