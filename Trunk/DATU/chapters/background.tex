...
Since we want to allow a wave to be able to travel in an arbitrary direction on a plane, we extend
equation~\ref{eq:sinusoid} in a straightforward manner to handle two dimensional input positions:
\begin{equation}
