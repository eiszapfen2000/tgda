...
of $\eta$, and displacement vector $\mvec{D}$, we also need to compute one 
partial derivative of $D_x$ as well as of $D_y$. As with the partial 
derivatives mentioned beforehand, we may compute them by means of spectral 
...
us to transform two spectra like one.
%
