...
one may combine them into one spectrum and apply a standard inverse Fourier Transform
...
Let $a$ and $b$ be real-valued signals with an identical underlying spatial domain.
