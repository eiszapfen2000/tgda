...
is correct as long as $\lambda \leq 0$, otherwise the effect is the opposite of 
...
Figure~\ref{fig:grid_displaced} for a comparison between an example instance of 
a displaced wave profile and its original wave profile.
%
\begin{figure}
\centering
\begin{tikzpicture}
