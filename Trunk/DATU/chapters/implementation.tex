...
hermitian because of two reasons. First, the wave energy spectrum $\Theta(\mvec{k})$ would need
...
As a consequence we employ a simple trick to guarantee that the spectrum is hermitian, whether
$\Theta(\mvec{k})$ is centrosymmetric or not. We may rewrite Equation~\ref{eq:dft_h0_k_t} as follows:
%
\begin{equation}
 h_0(\mvec{k}, t) =
