...
more pairs $(k_x, k_y)$ than $\mvec{l}$.
One may notice that $\mvec{l}$ is a subset of $\mvec{h}$,
all pairs $(k_x, k_y)$ in $\mvec{l}$ are also to be found in $\mvec{h}$. Hence,
there is no need to generate two separate instances of the wave spectrum with
differing resolutions, $\Theta(\mvec{h})$ and $\Theta(\mvec{l})$. As long as
the two different wavevector domains are based on the same pattern size,
$\mvec{l}$ is a subset of $\mvec{h}$, it follows that $\Theta(\mvec{l})$ is a
subset of $\Theta(\mvec{h})$. In short, the low resolution variant of the
wave spectrum is already embedded inside the high resolution variant.\\
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_1.dat};
\addplot[
  color=red,
  %draw=red,
  fill,
  ...
  {figures/sampling_multires_scale_06_res_64_lod_1.dat} \closedcycle;
\addplot[
  ycomb,
  color=red,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_2.dat};
\addplot[
  ycomb,
  color=blue,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_64_lod_2.dat} \closedcycle;
\nextgroupplot[
	ytick=\empty,
	axis y line=none,
	xmin = 0,
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_3.dat};
\addplot[
  ycomb,
  color=green,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_64_lod_3.dat} \closedcycle;
\nextgroupplot[
	ytick=\empty,
	axis y line=none,
	xmin = 0,
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_4.dat};
\addplot[
  ycomb,
  color=yellow,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_64_lod_4.dat} \closedcycle;
\nextgroupplot[
	ytick=\empty,
	axis y line=none,
	xmin = 0,
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_1.dat} \closedcycle;
\addplot[
  ycomb,
  color=red,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_2.dat} \closedcycle;
\addplot[
  ycomb,
  color=blue,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_3.dat} \closedcycle;
\addplot[
  ycomb,
  color=green,
  ]
...
\addplot[
  ...
  {figures/sampling_multires_scale_06_res_128_lod_4.dat} \closedcycle;
\addplot[
  ycomb,
  color=yellow,
  ]
