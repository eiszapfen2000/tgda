...
\subcaptionref{fig:symmetry:even:example} An even-sized spectrum ($N=4$). If replicated in both dimensions,
...
allows us to find matching complex conjugate pairs for all elements of an even-sized the spectrum.
