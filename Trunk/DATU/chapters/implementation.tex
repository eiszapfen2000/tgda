...
for a specific set of parameters such as area, resolution, wind and fetch.
%
...
\end{equation}
where $*$ denotes the complex conjugate operator. Surface elevation $\eta$ is a real-valued
function, therefore its spectrum $h_0$ must be hermitian, too. We may write
\begin{equation}
