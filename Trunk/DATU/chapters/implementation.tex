...
again due to multiple scattering. Because we are in deep water,
\citeauthor{article:oceanlighting} assume that no light is reflected from the
sea bed back to the water surface.
\citet{Bruneton:2008}
%That is, because 
