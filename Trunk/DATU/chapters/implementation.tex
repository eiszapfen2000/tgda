...
dataset resolutions.
As shown in Figure \ref{fig:sampling_different_resolutions_pattern_assembly},
...
range. In addition, we must take into consideration that the two sets of
spectral data have different \wavenumber ranges, therefore the transitions may
take place at different \wavenumbers.
