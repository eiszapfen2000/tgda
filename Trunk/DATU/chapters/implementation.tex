...
with wave spectra. As described by \citet{course:simulatingocean},
...
Second, the choppy wave algorithm may add displacements to the ocean surface for
it to better resemble an agitated sea where the waves have deep troughs and
sharp crests.
Third, based on the first-order partial derivatives of aforementioned
displacements one may be able to derive the locations on the ocean surface where
whitecaps may arise.
...
and burdening us with additional Fourier Transforms.
