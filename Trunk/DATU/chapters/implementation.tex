...
matching the hermitian matrix layout.
...
Surface elevation $\eta$ is a real-valued function, therefore we assume $h$ must be hermitian,
too. We may write
\begin{equation}
\label{eq:h0_k_complex_conjugate}
 h(\mvec{-k},t) = h(\mvec{k},t)^*
\end{equation}
where finding $h(\mvec{k},t)$ for its counterpart $h(-\mvec{k},t)$ has proven to be non-trivial
