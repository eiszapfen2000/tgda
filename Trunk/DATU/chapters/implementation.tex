...
then there is one row and one column of the spectrum $h_0(-\mvec{k},t)$ which lacks
matching elements $h_0(\mvec{k},t)^*$ inside said domain, see Table~\ref{tab:spectrum_k_minusk}.
