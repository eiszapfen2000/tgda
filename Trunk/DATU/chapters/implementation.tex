...
\subbottom{%
\begin{tabular}{S|SSS}
{\ccellnum{CenterColor}{1.36+0.00i}} & {\ccellnum{blue!15}{-1.34+1.24i}}                       & \ccellnum{CenterColor}{-1.04+0.00i}                     & {\ccellnum{blue!15}{-1.34-1.24i}} \\
\hline
{\ccellnum{violet!15}{0.67-0.65i}}   & \textcolor{gray!50}{\ccellnum{BorderColor}{0.07+0.37i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.87+0.03i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.71+0.21i}} \\
...
{\ccellnum{violet!15}{0.67+0.65i}}   & \textcolor{gray!50}{\ccellnum{BorderColor}{0.71-0.21i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.87-0.03i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.07-0.37i}} \\
\multicolumn{1}{S}{}                 &                                                         &                                                         &                                                         \\
\end{tabular}
}
\subbottom{%
\begin{tabular}{S|SSS|S}
{\ccellnum{violet!40}{1.36+0.00i}} & {\ccellnum{blue!15}{-1.34+1.24i}}                       & \ccellnum{red!20}{-1.04+0.00i}                          & {\ccellnum{blue!15}{-1.34-1.24i}}                       & {\ccellnum{violet!40}{1.36+0.00i}} \\
\hline
{\ccellnum{violet!15}{0.67-0.65i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.07+0.37i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.87+0.03i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.71+0.21i}} & {\ccellnum{violet!15}{0.67-0.65i}} \\
{\ccellnum{blue!40}{1.62+0.00i}}   & \textcolor{gray!50}{\ccellnum{BorderColor}{0.04+0.16i}} & \textcolor{red!50} {\ccellnum{BorderColor}{9.62+0.0i }} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.04-0.16i}} & {\ccellnum{blue!40}{1.62+0.00i}} \\
{\ccellnum{violet!15}{0.67+0.65i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.71-0.21i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.87-0.03i}} & \textcolor{gray!50}{\ccellnum{BorderColor}{0.07-0.37i}} & {\ccellnum{violet!15}{0.67+0.65i}} \\
\hline
{\ccellnum{violet!40}{1.36+0.00i}} & {\ccellnum{blue!15}{-1.34+1.24i}}                       & \ccellnum{red!20}{-1.04+0.00i}                          & {\ccellnum{blue!15}{-1.34-1.24i}}                       & {\ccellnum{violet!40}{1.36+0.00i}} \\
\end{tabular}
}
...
difference is the complex conjugation.
...
matching complex conjugate elements inside said domain, see Table~\ref{tab:spectrum_k_minusk}.
...
Let us view the spectrum $h_0$ as a two dimensional hermitian array with size $N \times N$.
...
The spectrum $h_0(\mvec{k},t)$ as given in Equation~\ref{eq:dft_h0_k_t} is not hermitian
because of two reasons. First, the wave energy spectrum $\Theta(\mvec{k})$ would need
to be centrosymmetric, which is only the case if the directional spread employed by
...
Second, random numbers are generated for each element of $h_0(\mvec{k})$, which makes it close
to impossible to end up with matching pairs $h_0(-\mvec{k})=h_0(\mvec{k})^*$. As a
consequence we employ a simple trick to guarantee the spectrum is hermitian, we may
rewrite Equation~\ref{eq:dft_h0_k_t} as follows:
%
\begin{equation}
 h_0(\mvec{k}, t) =
