...
table-number-alignment=right
 ...
 \subtop[]{
	...
	$\left(\begin{array}{llll|l}
	 ...
	 \num{3.5886 + 0.0i}     & \num{0.5354 - 0.9111i}  & \num{-8.3447 + 0.0i}   & \num{0.5354 + 0.9111i}  & \num{3.5886 + 0.0i} \\
	\end{array}\right)$
	\label{fig:symmetry:even:replicated}
 }
\caption{
\subcaptionref{fig:symmetry:odd} The spectrum $\mathcal{F}(\mvec{k})$ of an odd-sized ($N = 3$) and real-valued function $f(\mvec{x})$.
The zero frequency component is located at the center, highlighted in red.
\subcaptionref{fig:symmetry:even}
\subcaptionref{fig:symmetry:even:replicated}
}
\end{figure}
%
%
