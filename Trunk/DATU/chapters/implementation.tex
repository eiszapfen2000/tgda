...
%animation over time of $h_0(\mvec{k})$.
Thus, $h$ has to be computed unconditionally for all frames, whereas
$h_0$ is only synthesized anew in case parameters change.
%the exponential responsible for the animation has to be computed for all
%frames.
%
