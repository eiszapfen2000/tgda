...
If, on the other hand, we generate multiple patterns, then the patterns'
\wavenumbers ranges complement each other. Thus, we may be able to sample
a large \wavenumber range at a varying but reasonable density.
