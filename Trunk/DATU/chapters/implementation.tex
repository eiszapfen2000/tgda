...
The two dimensional displacement vector field $\mvec{D}$ is computed based on the spectrum $h_0$ as follows:
\begin{align}
...
%\label{eq:dft_displacement_correction}
 d(l, k) &= \begin{cases}
            ...
            \end{cases}
\end{align}
where, similar to spectral differentiation, the term $d(l, k)$ makes sure the resulting spectrum is hermitian.
