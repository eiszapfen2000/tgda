...
of an even one, the zero frequency component would be located precisely at the center of the
\wavevector domain. Actual implementations of the inverse DFT, such as
\citet{misc:fftw}, expect the zero frequency component as the first element i.e. at the
...
\subcaptionref{fig:zfreq:upperleft} The quadrant layout we seek, where the zero frequency component is held by the quadrant at the origin. Compared to \subcaptionref{fig:zfreq:center} the quadrants have been diagonally swapped.
