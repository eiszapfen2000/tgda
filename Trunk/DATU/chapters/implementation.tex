...
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q1Color}\num{1.36000 + 0.00000i}} & \cellcolor{Q1Color}\num{-1.34000 + 1.24000i} & \cellcolor{Q2Color}\num{-1.04000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\cellcolor{Q2Color}\num{-1.34000 - 1.24000i}} & \cellcolor{Q1Color}\num{1.36000 + 0.00000i} & \cellcolor{Q1Color}\num{-1.34000 + 1.24000i} \\
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q1Color}\num{0.67000 - 0.65000i}} & \cellcolor{Q1Color}\num{ 0.07000 + 0.37000i} & \cellcolor{Q2Color}\num{ 0.87000 + 0.03000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\cellcolor{Q2Color}\num{ 0.71000 + 0.21000i}} & \cellcolor{Q1Color}\num{0.67000 - 0.65000i} & \cellcolor{Q1Color}\num{ 0.07000 + 0.37000i}\\
\hhline{>{\arrayrulecolor{Line1Color}}|>{\arrayrulecolor{Q1Color}}-->{\arrayrulecolor{Line2Color}}*{4}{-}>{\arrayrulecolor{black}}}
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q3Color}\num{1.62000 + 0.00000i}} & \cellcolor{Q3Color}\num{ 0.04000 + 0.16000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\textcolor{red}{\num{ 9.62000 + 0.00000i}}} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\num{ 0.04000 - 0.16000i}} & \cellcolor{Q3Color}\num{1.62000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\cellcolor{Q3Color}\num{ 0.04000 + 0.16000i}}\\
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q3Color}\num{0.67000 + 0.65000i}} & \cellcolor{Q3Color}\num{ 0.71000 - 0.21000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\num{ 0.87000 - 0.03000i}} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\num{ 0.07000 - 0.37000i}} & \cellcolor{Q3Color}\num{0.67000 + 0.65000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\cellcolor{Q3Color}\num{ 0.71000 - 0.21000i}}\\
\hhline{>{\arrayrulecolor{Line1Color}}*{4}{-}>{\arrayrulecolor{Q3Color}}-->{\arrayrulecolor{Line2Color}}|}
\cellcolor{Q1Color}\num{1.36000 + 0.00000i} & \cellcolor{Q1Color}\num{-1.34000 + 1.24000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q2Color}\num{-1.04000 + 0.00000i}} & \cellcolor{Q2Color}\num{-1.34000 - 1.24000i} & \cellcolor{Q1Color}\num{1.36000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\cellcolor{Q1Color}\num{-1.34000 + 1.24000i}} \\
\cellcolor{Q1Color}\num{0.67000 - 0.65000i} & \cellcolor{Q1Color}\num{ 0.07000 + 0.37000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\cellcolor{Q2Color}\num{ 0.87000 + 0.03000i}} & \cellcolor{Q2Color}\num{ 0.71000 + 0.21000i} & \cellcolor{Q1Color}\num{0.67000 - 0.65000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\cellcolor{Q1Color}\num{ 0.07000 + 0.37000i}}\\
