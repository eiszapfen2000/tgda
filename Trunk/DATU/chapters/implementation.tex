...
\caption{Top row: reconstructed spectra of patterns with sizes reduced by
 $\varphi^{-1}$. Bottom row: spectra of patterns with sizes reduced by
$1-\varphi^{-1}$.}
...
substantial. To improve upon the status quo, we chose to implement a common
approach in computer graphics: combine low resolution geometry augmented with
