...
between two subsequent spectral datasets at different wavenumbers.}
...
spectrum to the next takes place at the maximum wavenumber of the spectrum with
the smaller wavenumber range. In addition, we must take into consideration that
the two sets of spectral data have different wavenumber ranges, therefore
the transitions take place at different wavenumbers. Figure
