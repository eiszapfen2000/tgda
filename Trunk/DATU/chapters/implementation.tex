...
%Let the spectrum $\mathcal{F}(\mvec{k})$
%be of even size in both dimensions, with the zero frequency component in the lower
%right quadrant. Then the elements of the first row and the first column of the spectrum
%lack their complex conjugate counterparts.
