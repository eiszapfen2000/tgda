...
all pairs $(k_x, k_y)$ in $\mvec{l}$ are also found in $\mvec{h}$. Hence, it is
not necessary to generate a separate low resolution version of the wave spectrum
$\Theta(\mvec{k})$, because it is already embedded inside the high resolution
wave spectrum.
