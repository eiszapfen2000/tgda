...
and their first order partial derivatives are periodic, too. As such, it is 
straightforward to extend our computations of displaced vertex coordinates as 
well as slopes to incorporate not just one perturbation pattern, but a set of 
patterns.
 Let $l \in 
