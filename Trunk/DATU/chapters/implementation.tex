...
determinant. Note, that surface self-intersections and negative Jacobian 
determinants overlap to a satisfying degree.}
...
depicts a displaced surface as well as the corresponding Jacobian determinant. 
We conclude, that we are able to find surface self-intersections based on the 
