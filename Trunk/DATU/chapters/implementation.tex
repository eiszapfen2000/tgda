...
At this point we are able to generate ocean surfaces in the form of simple
heightfields animated over time. For rendering purposes we will augment our
ocean surface representation with high-quality normals (Tessendorf), and
...
Section~\ref{sec:level_of_detail} discusses our wave spectrum specific approach
to level of detail. Last, Section~\ref{sec:demo_application} gives an overview
of the algorithms and techniques incorporated into our demo application.
...
algorithm~\citep{Cooley:1965}, which works fastest at such resolutions.
