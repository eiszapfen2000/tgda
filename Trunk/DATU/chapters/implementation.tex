...
%\DeclareRobustCommand{\ccellnum}[2]{\cellcolor{#1}\num{#2}}
...
\colorlet{Line2Color}{violet}
\setlength{\arrayrulewidth}{1pt}
%
\begin{tabular}{SSSSSS}
\hhline{>{\arrayrulecolor{Line1Color}}*{4}{-}~~}
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q1Color}{1.36000 + 0.00000i}} & \ccellnum{Q1Color}{-1.34000 + 1.24000i} & \ccellnum{Q2Color}{-1.04000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\ccellnum{Q2Color}{-1.34000 - 1.24000i}} & \ccellnum{Q1Color}{1.36000 + 0.00000i} & \ccellnum{Q1Color}{-1.34000 + 1.24000i} \\
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q1Color}{0.67000 - 0.65000i}} & \ccellnum{Q1Color}{ 0.07000 + 0.37000i} & \ccellnum{Q2Color}{ 0.87000 + 0.03000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\ccellnum{Q2Color}{ 0.71000 + 0.21000i}} & \ccellnum{Q1Color}{0.67000 - 0.65000i} & \ccellnum{Q1Color}{ 0.07000 + 0.37000i}\\
\hhline{>{\arrayrulecolor{Line1Color}}|>{\arrayrulecolor{Q1Color}}-->{\arrayrulecolor{Line2Color}}*{4}{-}>{\arrayrulecolor{black}}}
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q3Color}{1.62000 + 0.00000i}} & \ccellnum{Q3Color}{ 0.04000 + 0.16000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\textcolor{red}{\num{ 9.62000 + 0.00000i}}} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\num{ 0.04000 - 0.16000i}} & \ccellnum{Q3Color}{1.62000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\ccellnum{Q3Color}{ 0.04000 + 0.16000i}}\\
\multicolumn{1}{!{\color{Line1Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q3Color}{0.67000 + 0.65000i}} & \ccellnum{Q3Color}{ 0.71000 - 0.21000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\num{ 0.87000 - 0.03000i}} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line1Color}\vline}}{\num{ 0.07000 - 0.37000i}} & \ccellnum{Q3Color}{0.67000 + 0.65000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\ccellnum{Q3Color}{ 0.71000 - 0.21000i}}\\
\hhline{>{\arrayrulecolor{Line1Color}}*{4}{-}>{\arrayrulecolor{Q3Color}}-->{\arrayrulecolor{Line2Color}}|}
\ccellnum{Q1Color}{1.36000 + 0.00000i} & \ccellnum{Q1Color}{-1.34000 + 1.24000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q2Color}{-1.04000 + 0.00000i}} & \ccellnum{Q2Color}{-1.34000 - 1.24000i} & \ccellnum{Q1Color}{1.36000 + 0.00000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\ccellnum{Q1Color}{-1.34000 + 1.24000i}} \\
\ccellnum{Q1Color}{0.67000 - 0.65000i} & \ccellnum{Q1Color}{ 0.07000 + 0.37000i} & \multicolumn{1}{!{\color{Line2Color}\vline}S[table-number-alignment=right]}{\ccellnum{Q2Color}{ 0.87000 + 0.03000i}} & \ccellnum{Q2Color}{ 0.71000 + 0.21000i} & \ccellnum{Q1Color}{0.67000 - 0.65000i} & \multicolumn{1}{S[table-number-alignment=right] !{\color{Line2Color}\vline}}{\ccellnum{Q1Color}{ 0.07000 + 0.37000i}}\\
\hhline{~~>{\arrayrulecolor{Line2Color}}*{4}{-}>{\arrayrulecolor{black}}}
\end{tabular}
\caption{Example spectrum which consists of four colour-coded quadrants, the zero frequency is in red.
The spectrum repeats itself towards the right and the bottom. Blue frame: Zero frequency at the center.
Violet frame: Zero frequency at upper left.}
\end{table}
%
