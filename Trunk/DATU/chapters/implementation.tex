...
frequency at the center. Black frame: wavevector domain with zero frequency at the upper left.}
...
\caption{Swap quadrants diagonally to convert between wavevector domains.}
\end{table}
%
