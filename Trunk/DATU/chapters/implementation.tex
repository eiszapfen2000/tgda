...
Figure~\ref{fig:sampling_pattern_size_reduction}. Thus, we may be able
to sample a large \wavenumber range at a varying, but reasonable density.
Varying, because the sampling density changes from pattern to pattern based on
pattern size.

The \wavenumber ranges of the different patterns are partially overlapping,
