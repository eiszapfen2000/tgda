...
Because the grid point transformation maps from $\mathbb{R}^2$ to 
...
\addplot[
	...
	{figures/d_25_500km_x_dx_h_dxx_dxz_dzx_dzz.dat};
%\addlegendentry{$x$}
\addplot[
    color=ForestGreen,
    solid,
    ...
    table [
		col sep=comma, 
		x expr=\thisrowno{0} - 1.5*\thisrowno{1},
		y expr=(1-1.5*\thisrowno{3})*(1-1.5*\thisrowno{6}) - 
				((-1.5*\thisrowno{5}) * (-1.5*\thisrowno{4})),
	]
	{figures/d_25_500km_x_dx_h_dxx_dxz_dzx_dzz.dat};
\addplot[
    color=blue,
