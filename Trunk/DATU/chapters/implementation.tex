...
\emph{whitecaps}, are incorporated in their model. \citet{article:whitecaps},
on the other hand, extend the work of \citet{misc:oceanlightingfft}
to include whitecaps. Their approach is based on the method by \citet{course:simulatingocean}
