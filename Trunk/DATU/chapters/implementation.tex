...
not.
%
\subsubsection{Normals and Displacements}
%
...
direct consequence the surface's slopes, too. Given surface elevation 
$\eta(\mvec{x},t)$, displacement vector $\mvec{D}(\mvec{x},t) = 
...
slope  vector $\mvec{s}$ as follows:
\begin{equation}
