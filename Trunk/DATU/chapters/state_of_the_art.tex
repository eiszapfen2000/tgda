...
$\omega^2=kg\tanh (kh)$, where $h$ is the water depth.
To resemble breaking waves more closely \citeauthor{Peachey:1986} adds
particle systems to generate spray, and distorts the form of waves approaching
the sloping beach. Results of \cite{Peachey:1986} are shown in Figure~\ref{fig:peachey1986}.
%
\begin{figure}[!b]
\begin{tikzpicture}
\begin{axis}[
