...
\end{figure}
%
The assumption of infinite depth restricts these methods to deep water, they are
unable to include phenomena which arise near the shore, such as breaking waves
and wave refraction. \cite{Peachey:1986}, still in the realm of linear wave
theory, simulates waves near the shore through the relationship
...
\begin{figure}
 ...
 \caption{Source:~\cite{Fournier:1986}}
\end{figure}
%
...
$\mvec{k}$ the wave vector and $\omega$ the wave's angular frequency. The sum of
of Gerstner waves is as follows:
\begin{align}
...
to change their wavelength, their speed and their direction of travel. Second,
the circular orbit of Gerstner waves approaching the shore is transformed into
an elliptical orbit, which matches the shape of breaking waves more closely.
