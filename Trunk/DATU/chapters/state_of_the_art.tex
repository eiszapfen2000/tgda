...
\begin{figure}
 ...
 \caption{The displaced surface mesh in screen space. Geometry only. Geometry with per pixel
normals. Geometry with per pixel normals and BRDF. Source:~\cite{article:oceanlighting}}
\end{figure}
%
%
\begin{figure}
 ...
 \caption{Reflected sun light. Reflected sky light. Light refracted from water. Final result.
