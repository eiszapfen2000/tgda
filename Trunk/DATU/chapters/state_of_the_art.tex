...
notice that most of the radial mesh always is outside the view frustum,
...
ocean surface at rest, see Figure~\ref{fig:hinsinger:mesh}.
\citeauthor{Hinsinger:2002} synthesize waves as a sum of Gerstner waves, where
the vertices represent the sampling points. To reduce aliasing as well as to save
computation time, wavetrains smaller than a grid quad are removed from the sum
of waves for that quad.
