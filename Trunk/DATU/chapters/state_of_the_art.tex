...
Phenomena such as wave refraction, where wavefronts tend to align themselves
parallel to the sloping beach regardless of their initial orientation,
as well as the steepening and eventual breaking of waves are caused by the
waves' transition into shallow water.
% The propagation speed of waves is dependent on the water's depth, with
% waves moving more slowly in shallow water.
% 
% such as steepening and breaking.
% they are unable to include phenomena which arise near the shore, such as breaking
% waves and wave refraction.
\cite{Peachey:1986}, still in the realm of linear
...
and rounded crests, and short choppy waves with sharp crests. To resemble waves
near the breaking point more closely, \citeauthor{Peachey:1986} steepens the front
of the crests of such waves even more, and stretches out the back of the crests,
giving the wave profiles an asymmetric form.
...
% As water depth decreases, so does the speed and wavelength of the waves,
% but amplitude and frequency remain the same. It follows that waves
% gain in steepness with declining water depth.
% To resemble breaking
% waves more closely \citeauthor{Peachey:1986} distorts the form of waves
% approaching the sloping beach, and adds particle systems to generate spray.
...
We may write a sum of Gerstner waves as follows:
\begin{align}
...
\end{figure}
%
To model waves in shallow water, \citeauthor{Fournier:1986} extend the Gerstner
...
\cite{Ts'o:1987} compute wave propagation near the shore with an algorithm
...
\citeauthor{Gonzato:2000} augment their work with the inclusion of wave
diffraction, see \cite{Gonzato:2000}.\\
