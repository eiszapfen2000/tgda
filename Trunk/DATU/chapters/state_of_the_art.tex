...
$\omega^2=kg\tanh (kh)$, where $h$ is the uniform water depth. Moreover,
\citeauthor{Peachey:1986} distorts the waves so that they resemble breaking
waves more closely, and adds particle systems to generate spray. Results of
\cite{Peachey:1986} are shown in Figure~\ref{fig:peachey1986}.
