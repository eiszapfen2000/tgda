...
preetham_sRGB_D65_turbidity_2_thetaSun_0  = lsRGB2sRGB(XYZ2lsRGB(xyY2XYZ(tonemapReinhard(preetham_xyY_turbidity_2_thetaSun_0,  0.18, 50)),XYZ2sRGBD65));
...
imshow(preetham_sRGB_D65_turbidity_2_thetaSun_0);
