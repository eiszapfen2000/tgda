...
figure
hold on
% plot(omega, j_pm_wp_1);
plot(omega, j_wp_25_wc_083);
plot(omega, j_wp_25_wc_1);
plot(omega, j_wp_25_wc_2);
plot(omega, j_wp_25_wc_3);
...
% plot(omega, j_pm_10);
% plot(omega, j_10_5km);
% plot(omega, j_10_10km);
% plot(omega, j_10_25km);
% plot(omega, j_10_50km);
% plot(omega, j_10_75km);
% plot(omega, j_10_100km);
% hold off
...
% plot(omega, j_pm_10);
% plot(omega, j_10_100km);
% plot(omega, j_10_200km);
% plot(omega, j_10_300km);
% plot(omega, j_10_400km);
% plot(omega, j_10_500km);
% hold off
