...
used for each patch is determined based on some criteria, usually the distance
to the viewer. Figure \ref{fig:lodscheme} depicts a possible instance of a LOD
scheme.
\begin{figure}
\begin{center}
