...
\FIXME{Figures showing the projected grid principle}
\FIXME{Show (x,y) = line in canonical cube problem}

\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{Images/ProjectedGridSenkrecht.pdf}
